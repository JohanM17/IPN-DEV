    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="rounded-xl p-10 text-white shadow-xl relative overflow-hidden group border-b-4 border-r-4 border-black/10"
          ...
          <div className="relative flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-left">
              <h1 className="text-3xl font-black tracking-tighter uppercase italic">Panel de Inventarios</h1>
              <p className="text-lg mt-1 text-white/80 font-medium">
                LOGÍSTICA IPN-DEV <span className="mx-2 opacity-30">|</span> <span className="text-white">{sesion?.usuario.nombre}</span>
              </p>
              <div className="mt-4 flex flex-wrap justify-center sm:justify-start gap-2">
                <span className="px-3 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest bg-black/20 border border-white/10">Stock</span>
                <span className="px-3 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest bg-black/20 border border-white/10">Control</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="lg:col-span-4 space-y-8">
        ...
        <div className="space-y-4">
          <h3 className="text-xs font-black uppercase tracking-[0.2em] text-slate-400 px-2">Estado del Almacén</h3>
